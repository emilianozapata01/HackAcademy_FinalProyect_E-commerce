          ...
          <div className="col-6 d-flex align-items-center justify-content-center mt-5">
            <div className="text-center">
              ...
              <p>
                ...
                local organic farms and cultivating long-standing relationships
                in alignment with seasonality and availability. Along with
                supporting sustainable and organic farming practices, glass has
                always been at the forefront of Juice Shop’s guiding principles.
                We choose glass not only because it retains the flavor of the
                juice and is the safest material to drink from (glass does not
                degrade or leach chemicals), but it is the best choice for the
                environment. We buy back all of our 16oz juice bottles after use
                to wash, reuse, and create a closed-loop system. We have saved
                over 5 million plastic bottles (and counting) from entering
                landfills and waterways. As a mindful business, we believe that
                this accountability for our practices can create a significant
                impact and stand for something larger than ourselves.
              </p>
            </div>
          </div>
        </div>
