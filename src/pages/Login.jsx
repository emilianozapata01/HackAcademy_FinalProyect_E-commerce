    ...
    <>
      <div className="d-flex justify-content-center">
        <form className={LoginStyle.form}>
          <p className={LoginStyle.heading}>Login</p>
          ...
          <div className={LoginStyle.btn}>
            <button className={LoginStyle.button1}>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Login&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </button>
            <button className={LoginStyle.button2}>Sign Up</button>
          </div>
          <button className={LoginStyle.button3}>Forgot Password</button>
        </form>
      </div>
    </>
  );
